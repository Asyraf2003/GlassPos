...
| `0021_cashier_final_preproduction_ux_hardening_handoff.md` | Cashier final pre-production UX hardening + two-focus history | closed locally; production/device verification next |
