...
| `0019_cloudflare_r2_static_sync_direct_upload_handoff.md` | Cloudflare R2 static sync + private direct-upload migration | active: public CDN + privacy + `make verify` proven; strict private direct-upload adapter proof next |
