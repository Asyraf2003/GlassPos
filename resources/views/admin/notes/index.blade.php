...
<section class="section">
    <div class="card">
        <div class="card-header">
            <div class="d-flex flex-column flex-md-row justify-content-end gap-2 align-items-stretch">
                <form id="admin-note-search-form" class="m-0 d-flex">
                    <input
                        type="text"
                        id="admin-note-search-input"
                        class="form-control py-2"
                        placeholder="Cari pelanggan, no. HP, atau rincian"
                        autocomplete="off"
