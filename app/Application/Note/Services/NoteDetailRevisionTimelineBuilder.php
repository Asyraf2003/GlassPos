    ...
    public function build(NoteRevision $current, array $timeline): array
    {
        ...
        return [
            ...
            'baseline' => [
                ...
                'subtotal_before_note_tax_rupiah' => $baselineRevision->subtotalBeforeNoteTaxRupiah(),
                'note_tax_input' => $baselineRevision->noteTaxInput(),
                'note_tax_mode' => $baselineRevision->noteTaxMode(),
                'note_tax_rate_basis_points' => $baselineRevision->noteTaxRateBasisPoints(),
                'note_tax_amount_rupiah' => $baselineRevision->noteTaxAmountRupiah(),
