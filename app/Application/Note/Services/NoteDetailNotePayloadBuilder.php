...
final class NoteDetailNotePayloadBuilder
{
    public function build(
        ...
        return $base + [
            ...
            'subtotal_before_note_tax_rupiah' => $operational['subtotal_before_note_tax_rupiah'] ?? $operational['grand_total_rupiah'],
            'note_tax_input' => $operational['note_tax_input'] ?? null,
            'note_tax_mode' => $operational['note_tax_mode'] ?? 'none',
            'note_tax_rate_basis_points' => $operational['note_tax_rate_basis_points'] ?? null,
            'note_tax_amount_rupiah' => $operational['note_tax_amount_rupiah'] ?? 0,
