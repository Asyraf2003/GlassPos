...
use App\Adapters\Out\Procurement\LaravelSupplierPaymentProofFailureReporterAdapter;
...
class ProcurementPaymentServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(MobileSupplierHubReaderPort::class, DatabaseMobileSupplierHubReaderAdapter::class);
        ...
        $this->app->singleton(SupplierPaymentProofFailureReporterPort::class, LaravelSupplierPaymentProofFailureReporterAdapter::class);
